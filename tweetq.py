...
def tweet_quote(api,quote):
    """
    If the quote is less than 280 chars tweet it and return.
    If not, partition it using partition_quote() and check if it returns
    ...
    if quote_re is None:
      ...
      if len(quote_re.groups())<2:
        ...
        """
        Get the 2 parts after partitioning 1/2 times
        and print/log the both parts and send them to tweet
